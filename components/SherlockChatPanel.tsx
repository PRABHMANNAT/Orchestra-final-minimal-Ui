    ...
    <section className="relative h-screen border-r border-[#78716C]/70 bg-[#FAF8F5] dark:border-white/[0.06] dark:bg-[#0A0A0A]">
      ...
      {!hasConversation ? (
        <div className="relative flex h-full flex-col items-center justify-center px-8 pb-28">
          ...
          <h2 className="mt-10 text-center text-[30px] font-normal leading-[1.25] tracking-[-0.07em] text-[#1A1612] dark:text-white/70">
            Who&apos;s the one
            <br />
            you&apos;re
            <br />
        ...
        <div className="relative flex h-full flex-col px-6 pb-28 pt-8">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] font-bold tracking-[-0.03em] text-[#1A1612] dark:text-white/70">proof search live</p>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-4 overflow-y-auto pr-1">
            ...
            {flowState === "analysing" && (
              <div className="rounded-[24px] border border-[#78716C] bg-[#FFFFFF]/95 px-4 py-3 text-[12px] font-bold text-[#78716C] shadow-[0_8px_20px_rgba(26, 22, 18,0.08)] dark:border-white/10 dark:bg-[#141414] dark:text-white/60">
    ...
    >
      <div className="relative rounded-[22px] bg-[#FFFFFF]/95 p-2 shadow-[0_18px_45px_rgba(26, 22, 18,0.14)] backdrop-blur-xl dark:bg-[#141414] dark:shadow-none">
        <input
          ...
          className="h-[54px] w-full rounded-[17px] bg-transparent px-5 pr-14 text-[19px] tracking-[-0.06em] text-[#1A1612] outline-none placeholder:text-[#78716C] dark:text-white dark:placeholder:text-white/30"
        />
        <button
          type="submit"
  ...
  return (
    ...
    >
      <div className={isUser ? "max-w-[86%]" : "max-w-[92%]"}>
        <div
          className={
            isUser
              ...
              : "max-w-full rounded-[24px] rounded-tl-md border border-[#78716C] bg-[#FFFFFF]/95 px-4 py-3 text-[12px] font-bold leading-5 tracking-[-0.03em] text-[#78716C] shadow-[0_8px_20px_rgba(26, 22, 18,0.08)] dark:border-white/10 dark:bg-[#141414] dark:text-white/70"
          }
        >
          {message.text}
        </div>
        ...
        {message.attachment && (
          <div className="mt-2 rounded-[18px] border border-[#78716C] bg-[#FAF8F5]/70 p-3 dark:border-white/10 dark:bg-white/5">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#B8543D]">{message.attachment.label}</p>
            <p className="mt-1 break-words text-[11px] font-bold text-[#1A1612] dark:text-white/80">{message.attachment.value}</p>
          </div>
        )}
...
function ContextReadyCard({ context, onAnalyse }: { context: SearchContext; onAnalyse: () => void }) {
  return (
    <motion.div
      ...
      className="rounded-[26px] border border-[#78716C] bg-[#FFFFFF]/95 p-4 shadow-[0_8px_20px_rgba(26, 22, 18,0.08)] dark:border-white/10 dark:bg-[#141414]"
    >
      <p className="text-[11px] font-black uppercase tracking-[0.26em] text-[#78716C] dark:text-white/40">Context ready</p>
      <div className="mt-3 space-y-2 text-[12px] font-bold text-[#1A1612] dark:text-white/80">
      ...
      <button
        onClick={onAnalyse}
        className="mt-4 w-full rounded-2xl bg-[#B8543D] px-4 py-4 text-[12px] font-black uppercase tracking-[0.22em] text-white shadow-[0_18px_40px_rgba(184, 84, 61,0.24)] transition hover:scale-[1.01]"
      >
        Analyse Profile
      </button>
    </motion.div>
